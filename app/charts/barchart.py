    ...
    return chart_container(
        G(
            G(
                ...
                Template(
                    G(
                        Text(text_anchor="end", alignment_baseline="middle",**{"x-text": "t[1]",
            ...
            G(
                ...
                Template(
                    G(
                        ...
                        Text(x=-10, y=0, text_anchor="end", alignment_baseline="middle", x_text="t"),
            ...
            G(
                Template(
                Rect(0,0, **{"x-bind:x": "bar.x", "x-bind:y": "bar.y", "x-bind:width": "bar.width", "x-bind:height":"bar.height", "x-bind:fill": "bar.fill"}),
                **{"x-for": "bar in bars"})
            ),
        ...
        **{
            ...
            # "x-init": '$nextTick(() => {render($store.framework.data);})',
        }
